...
public class TC001_FAProgramVersionsCRUDTestCases extends BaseClass {
	...
	public static String ExcelSheet_FilePatchFAProgramVersion = "C:\\GopalBackUp\\WorkSpace\\APIRestAssuredToolsQA\\src\\main\\BaseClasses\\TestDataFromExcel\\FAProgramVersions.xlsx";
	public static String ExcelSheet_FilePatchADProgramVersion = "C:\\GopalBackUp\\WorkSpace\\APIRestAssuredToolsQA\\src\\main\\BaseClasses\\TestDataFromExcel\\AdProgramVersions.xlsx";
	public static String ExcelSheet_FilePatchADTerms = "C:\\GopalBackUp\\WorkSpace\\APIRestAssuredToolsQA\\src\\main\\BaseClasses\\TestDataFromExcel\\FAProgramVersions.xlsx";
	...
	public static List<String> idTerms_responsepayload_data = new ArrayList<String>();
	...
	public void CreateADProgramVersion(String code, String name, String creditHoursRequired, String clockHoursRequired,
	...
	public void CreateTerms(String code, String name, String startDate, String endDate, String faAcademicCalendar,
		...
		System.out.println("Create Payload for Terms" + data);
		...
		idTerms_responsepayload_data.add(jsonPathEvaluator.getString("payload.data.id"));
	...
	public Object[][] setNewTermsexceldata() {
		...
		Object [][]data_excelNew = UtilClass.setData("1", ExcelSheet_FilePatchADTerms);
